 ...
 */
function buildFileSubmenu(): MenuItemConstructorOptions[] {
    ...
    },
    {
      ...
      click: async () => {
        const result = await dialog.showSaveDialog(state.mainWindow!, {
          title: "Export Chat",
          defaultPath: path.join(app.getPath("documents"), "chat-export.txt"),
          filters: [
...
function buildHelpSubmenu(): MenuItemConstructorOptions[] {
  return [
    ...
    },
    {
      label: "API Reference",
      click: async () => {
        await shell.openExternal("https://docs.anthropic.com/en/api/getting-started");
      },
    },
    {
      label: "GitHub Repository",
      click: async () => {
        await shell.openExternal("https://github.com/anthropics/anthropic-sdk-typescript");
      },
    },
    { type: "separator" },
    {
      ...
      click: async () => {
        await shell.openExternal("https://github.com/anthropics/anthropic-sdk-typescript/issues");
      },
    },
    { type: "separator" },
    {
